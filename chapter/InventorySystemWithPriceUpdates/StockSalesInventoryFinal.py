...
# -------------------------------
def update_inventory(inventory, sales, stock_in):
...
# -------------------------------
def run_daily_simulation(inventory, products, sales, stock_in, days=5):
    ...
    for day in range(days):
        ...
        # Update inventory
        today_inventory = update_inventory(today_inventory, daily_sales, daily_stock)

        # Update prices every 6 months
        current_products = update_prices(current_products, current_date)
...
# -------------------------------
def generate_report(inventory, sales, products):
...
# RUN SIMULATION
# -------------------------------
final_inventory, updated_products = run_daily_simulation(
    inventory, products, sales, stock_in, days=5
)

report = generate_report(final_inventory, sales, updated_products)
